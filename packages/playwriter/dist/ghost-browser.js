 ...
 */
function createGhostBrowserProxy(namespace, constants, sendCommand) {
    return new Proxy(constants, {
        get(target, prop) {
            ...
            return (...args) => sendCommand(namespace, prop, args);
        },
    });
}
/**
 ...
 */
export function createGhostBrowserChrome(sendCommand) {
    return {
 ...
 */
export async function handleGhostBrowserCommand(params, chromeApi) {
...
//# sourceMappingURL=ghost-browser.js.map