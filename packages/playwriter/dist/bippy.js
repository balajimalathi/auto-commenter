(() => {
  // ../node_modules/.pnpm/bippy@0.5.30_@types+react@19.2.11_react@19.2.4/node_modules/bippy/dist/rdt-hook-BvBEbB9n.js
  var e = `0.5.30`;
  var t = `bippy-${e}`;
  ...
  // ../node_modules/.pnpm/bippy@0.5.30_@types+react@19.2.11_react@19.2.4/node_modules/bippy/dist/install-hook-only-TrTYr6LK.js
  _();

  // ../node_modules/.pnpm/bippy@0.5.30_@types+react@19.2.11_react@19.2.4/node_modules/bippy/dist/core-DrcMh8Kr.js
  var a2 = 0;
  var o2 = 1;
  var c2 = 5;
  var f2 = 11;
  ...
  // ../node_modules/.pnpm/bippy@0.5.30_@types+react@19.2.11_react@19.2.4/node_modules/bippy/dist/source.js
  ...
  var D = `(at Server)`;
  var ae2 = /(^|@)\S+:\d+/;
  var oe2 = /^\s*at .*(\S+:\d+|\(native\))/m;
  var se2 = /^(eval@)?(\[native code\])?$/;
  var O2 = (e2, t2) => {
...
`), r2 = [];
  ...
  var k2 = (e2) => {
    ...
    let t2 = e2.startsWith(`(`) && /:\d+\)$/.test(e2), n2 = t2 ? e2.slice(1, -1) : e2, r2 = /(.+?)(?::(\d+))?(?::(\d+))?$/, i2 = r2.exec(n2);
    return i2 ? [i2[1], i2[2] || undefined, i2[3] || undefined] : [n2, undefined, undefined];
  };
  var A2 = (e2, t2) => t2 && t2.slice != null ? Array.isArray(t2.slice) ? e2.slice(t2.slice[0], t2.slice[1]) : e2.slice(0, t2.slice) : e2;
  var j2 = (e2, t2) => {
    let n2 = A2(e2.split(`
`).filter((e3) => !!e3.match(oe2)), t2);
    return n2.map((e3) => {
      ...
      let i2 = k2(r2 ? r2[1] : n3), a3 = r2 && n3 || undefined, o3 = [`eval`, `<anonymous>`].includes(i2[0]) ? undefined : i2[0];
...
`).filter((e3) => !e3.match(se2)), t2);
  ...
  var I2 = C2(fe2(), 1);
  var L2 = /^[a-zA-Z][a-zA-Z\d+\-.]*:/;
  var pe2 = /^data:application\/json[^,]+base64,/;
  var me2 = /(?:\/\/[@#][ \t]+sourceMappingURL=([^\s'"]+?)[ \t]*$)|(?:\/\*[@#][ \t]+sourceMappingURL=([^*]+?)[ \t]*(?:\*\/)[ \t]*$)/;
  var R = typeof WeakRef < `u`;
  var z2 = new Map;
  var B2 = new Map;
  var he2 = (e2) => R && e2 instanceof WeakRef;
  var V2 = (e2, t2, n2, r2) => {
  ...
  var H2 = (e2, t2, n2) => {
    if (e2.sections) {
      ...
      return V2(r2.map.mappings, r2.map.sources, i2, a3);
    }
...
`), r2;
    ...
    if (!r2)
      return null;
    let i2 = L2.test(r2);
    if (!(pe2.test(r2) || i2 || r2.startsWith(`/`))) {
      let t3 = e2.split(`/`);
      t3[t3.length - 1] = r2, r2 = t3.join(`/`);
    }
    return r2;
  };
  var _e2 = (e2) => ({ file: e2.file, mappings: (0, I2.decode)(e2.mappings), names: e2.names, sourceRoot: e2.sourceRoot, sources: e2.sources, sourcesContent: e2.sourcesContent, version: 3 });
  var ve2 = (e2) => {
    let t2 = e2.sections.map(({ map: e3, offset: t3 }) => ({ map: { ...e3, mappings: (0, I2.decode)(e3.mappings) }, offset: t3 })), n2 = new Set;
    for (let e3 of t2)
  ...
  var K2 = async (e2, t2 = true, n2) => await Promise.all(e2.map(async (e3) => {
    if (!e3.fileName)
      return e3;
    let r2 = await G2(e3.fileName, t2, n2);
    if (!r2 || typeof e3.lineNumber != `number` || typeof e3.columnNumber != `number`)
      return e3;
    let i2 = H2(r2, e3.lineNumber, e3.columnNumber);
  ...
  var q = (e2) => e2._debugStack instanceof Error && typeof e2._debugStack?.stack == `string`;
  var ye2 = () => {
    let n2 = h();
...
${t3[r4].replace(` at new `, ` at `)}`, i4 = Te(e2);
      ...
      X2 = false, Error.prepareStackTrace = n2, J(r2), console.error = i2, console.warn = a3;
    }
      ...
      do {
        ...
        if (e3 && Array.isArray(e3))
          for (let n3 = e3.length - 1;n3 >= 0; n3--) {
            let r3 = e3[n3];
            typeof r3.name == `string` && (t2 += be2(r3.name, r3.env));
          }
        r2 = n2, n2 = n2.return;
      } while (n2);
      return t2;
...
`, r2)), r2 !== -1)
  ...
  var Q = async (e2, t2 = true, n2) => {
    let r2 = Oe(e2), i2 = O2(Se2(e2)), a3 = Ee2(r2), o3 = new Map, s3 = i2.map((e3) => {
  ...
  var $2 = (e2) => e2.split(`/`).filter(Boolean).length;
  var je2 = (e2) => {
  ...
  var Me2 = (e2) => {
    ...
    if (!E.test(r2) || $2(r2) < 2)
      return e2;
    let i2 = je2(r2);
    return !i2 || i2.startsWith(`@`) || i2.length > 4 ? e2 : r2;
  };
  var Ne2 = (e2) => {
  ...
  // dist/_bippy-entry-31716-1770281261824.js
  globalThis.__bippy = {
